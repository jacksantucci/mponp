...
"https://tinyurl.com/moreparties"><i>More Parties or No Parties: The Politics of Electoral Reform in America</i></A>. The data will be useful to scholars of the single transferable vote (STV), urban political development, historical political economy, and whatever other fields I can't now remember or that haven't yet been proposed.

Code and data are organized by chapter. I will endeavor to provide a readme file within each chapter's folder. The code was written over many years. Most of it was last run in February 2022, just before I sent the manuscript to the publisher. Multiple versions of R were used over the years. I generally try to avoid loading pacakges, but this was less true in the mid-2010s. This repository is a work in progress.
