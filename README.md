...
Code and data are organized by chapter. I will endeavor to provide a readme file within each chapter's folder. Some files are more user-friendly than others. I wrote the R code over several years in many different versions of the program. I last ran all of in February 2022, minus the analysis of spending in chapter 6.
